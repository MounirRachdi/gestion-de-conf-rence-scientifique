...
if($type=='examinateur')
{
$req="select * from examinateur where login='$login' and password='$password'";
...
if($num>0)
{
$query = "SELECT id_papier, nom FROM papier";
...
{?>
<div align="right"><?php echo $line[0];?><a href="logout.php">Deconnexion</a></div>
<center><strong>Liste des papiers</strong></center> <br><br><br>
<table border='1' width="100%" height="100%">
<tr><th>Papier</th><th>Telecharger</th></tr>
<?php
while(list($id, $nom, $data) = mysql_fetch_array($result))
{
?>
...
<a href="papier.php?id=<?php echo $id;?>">Telecharger </a> </td></tr>
<?php 
}?>
</table>
...
//session_register();
$req="select * from auteur where login='$login' and password='$password'";
$res=mysql_query($req) ;
 if (@mysql_num_rows($res)>0)
header("location:souver_papier.php");
else
echo "verfier vos information logi ou mot de passe incorrect";
