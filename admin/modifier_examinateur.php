...
$id=$_GET["id"];
$_SESSION["id_exam"]=$id;
$req="select * from examinateur where id_examinateur=$id";
$res=mysql_query($req) or die(mysql_error());
$ligne=mysql_fetch_row($res);
 
?>
<form method="post" action="confirm_modif_ex.php"><center>
<h2><span class="Style1"> Modification d'un examinateur </span></h2></center><br /><br />
