...
$id=$_GET["id"];
$_SESSION["id_resp"]=$id;
$req="select * from responsable where id_resp=$id";
$res=mysql_query($req) or die(mysql_error());
$ligne=mysql_fetch_row($res);
 
?>
<form method="post" action="confirm_modif_resp.php"><center>
<h2><span class="Style1"> Ajout d'un auteur </span></h2></center><br /><br />
<table border="0" align="center">
<tr><td>Nom de l'examinateur:</td>
...
<tr><td>Ville:</td>
<td><input type="text" name="ville" value="<?php echo $ligne[7]; ?>" required /></td>
<td>Telephone: </td><td>
<input type="text" name="telephone" value="<?php echo $ligne[8]; ?>" required /></td>

</tr>
<tr><td colspan="2" align="center">
<input type="submit" value="Modifier" name="submit" class="bouton" />
</td>
