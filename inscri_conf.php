...
<form method="post" action="confir_inscri_conf.php.php" id="form">
...
<option value="admin">Administrateur</option>
  ...
  <tr>
    <td height="56" align="center" ><input id="Button1" type="submit" value="s'inscrire" width="101px" height="30px" class="submit"  /> </td>
  </tr><tr><td width="465" height="42" align="center">
	<a href=""  class="lien" >Mot de passe oublié?</a>   <a href="inscription.php" class="lien">Creer un compte</a> </td>
  <td width="101"></td>
  </tr>
</table>
</fieldset>
...
<div id="tooplate_footer_wrapper">
     <div id="tooplate_footer">
        ...
        Copyright &copy; 2048 <a href="#">Company Name</a>
